...
void handleMessage(uint8_t *payload)
{
  ...
  if (strcmp(doc["type"], "cmd") == 0)
  {
    ...
    if (strcmp(doc["body"]["type"], "digitalWrite") == 0)
    {
      ...
      if (doc["body"]["pin"] == 18)
        outgoingSetpoints.rele1 = doc["body"]["value"];
      if (doc["body"]["pin"] == 19)
        outgoingSetpoints.rele2 = doc["body"]["value"];
      if (doc["body"]["pin"] == 22)
        outgoingSetpoints.rele3 = doc["body"]["value"];
    ...
    if (strcmp(doc["body"]["type"], "digitalRead") == 0)
    {
      ...
      {
      case 18:
        digitalReadValue = rele1IncomingValue;
        break;
      case 19:
        digitalReadValue = rele2IncomingValue;
        break;
      case 22:
        digitalReadValue = rele3IncomingValue;
        break;
      }
      ...
      sprintf(msg, "{\"action\":\"msg\",\"type\":\"output\",\"body\":{\"pin\": %d, \"digitalReadValue\": %d}}",
              pin, digitalReadValue);
